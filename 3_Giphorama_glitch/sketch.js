...
function mouseReleased(){
  ...
  glitch.loadImage(gifImg);
  glitch.randomBytes(random(3)); // randomize 10 bytes
  glitch.replaceBytes(random(10), random(20)); // find + replace all
...
function draw() {
  ...
  image(glitch.image, mouseX, mouseY); // display glitched image
}
